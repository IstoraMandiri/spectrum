...
export const DEFAULT_NETWORKS = [
  {
    name: '[#27]Ethereum',
    symbol: 'ETH',
    description: '[#65]Official Ethereum Mainnet',
  ...
  },
  {
    name: '[#28]Kovan',
    symbol: 'KETH',
    description: '[#66]Kovan PoA Testnet',
  ...
  {
    name: '[#29]Ethereum Classic',
    symbol: 'ETC',
    description: '[#67]Old Unforked Chain',
  ...
  },
  {
    name: '[#30]TestRPC',
    symbol: 'ETH-testrpc',
    description: '[#68]Virtual Test Chain',
...
export const DEFAULT_KEYSTORE_TYPES = [
  {
    id: 'v3',
    name: '[#10]Single Account',
    subtitle: '[#14]v3 Encrypted Keystore',
    description: '[#20]The standard "default" wallet used by Geth, Parity, and many other services',
    color: 'green',
    icon: 'key',
  },
  {
    id: 'ledger',
    name: '[#11]Ledger Wallet',
    subtitle: '[#15]Nano S (or blue) Hardware Wallet',
    description: '[#37]Ethereum hardware wallet, based on robust safety features for storing cryptographic assets and securing digital payments. It connects to any computer via USB.',
    color: 'black',
    icon: 'usb',
  },
  {
    id: 'cold',
    name: '[#12]Cold Accounts',
    subtitle: '[#16]for Offline Signing / Read Only',
    description: '[#38]Reference to an Ethereum address that allows for generating offline signing data, or simply checking account balances',
    color: 'blue',
    icon: 'hide',
  },
  {
    id: 'multisig',
    name: '[#13]MultiSig Wallet',
    subtitle: '[#17]Multi-party sigining for increased security',
    description: '[#46]Assigns multiple other keystores to administer a contract that can execute transactions with a miniumum threashold of approvals',
    color: 'orange',
    icon: 'users',
  },
];
